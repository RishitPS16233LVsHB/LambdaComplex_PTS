class Tables:
    # User 
    User = "[LambdaComplex].[dbo].[LambdaComplex_User_Mst_Tbl]"
    ...
    # Teams
    Team = "[LambdaComplex].[dbo].[LambdaComplex_Team_Mst_Tbl]" 
    TeamMember = "[LambdaComplex].[dbo].[LambdaComplex_TeamMember_Trn_Tbl]"
